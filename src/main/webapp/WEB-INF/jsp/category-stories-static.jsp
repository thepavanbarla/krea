...
<title>Krea | Breath-taking Travel Stories on Krea</title>
...
<body>
	...
	<jsp:include page="includes/header.jsp">
		<jsp:param name="pageType" value="categoryStories"/>
	</jsp:include>
			...
			<div class="horizontal_items">
				...
				<div class="horizontal_item_space">
					<div class="horizontal_item"
						style="background-image: url('/images/bali.jpg');">
						<div class="item_details">
							<span class="category">TRAVEL</span>
							<h3 class="item_title">These Bali Rice Gardens will give you
								Travel Goals</h3>
						</div>
					</div>
				</div>
				...
				<div class="horizontal_item_space">
					<div class="horizontal_item"
						...
						<div class="item_details">
							...
							<h3 class="item_title">10 beaches You Must Visit while
								you're alive</h3>
						</div>
					</div>
				</div>
				...
				<div class="horizontal_item_space">
					<div class="horizontal_item"
						...
						<div class="item_details">
							<span class="category">TRAVEL</span>
							<h3 class="item_title">These Nature's Wonders will leave you
								speechless</h3>
						</div>
					</div>
				</div>
				...
				<div class="horizontal_item_space">
					<div class="horizontal_item"
						...
						<div class="item_details">
							<span class="category" style="background: navy;">WATER</span>
							<h3 class="item_title">Cats can smell things that you can't
								smell</h3>
						</div>
					</div>
				</div>
				...
				<div class="horizontal_item_space">
					<div class="horizontal_item"
						style="background-image: url('/images/cappadocia.jpg');">
						<div class="item_details">
							<span class="category">TRAVEL</span>
							<h3 class="item_title">These Nature's Wonders will leave you
								speechless</h3>
				...
				<div class="horizontal_item_space">
					<div class="horizontal_item"
						style="background-image: url('/images/brand_bg.jpg');">
						<div class="item_details">
							<span class="category">TRAVEL</span>
							<h3 class="item_title">These Nature's Wonders will leave you
								speechless</h3>
				...
				<div class="horizontal_item_space">
					<div class="horizontal_item"
						style="background-image: url('/images/mu-cang.jpg');">
						<div class="item_details">
							<span class="category">TRAVEL</span>
							<h3 class="item_title">These Nature's Wonders will leave you
								speechless</h3>
