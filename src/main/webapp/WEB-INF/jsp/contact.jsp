...
<body>
	...
	<div id="page_content">
		...
		<div class="horizontal_section">
			...
			<h2 class="title">${category.categoryName} Stories</h2>

			<div id="category_stories" class="horizontal_items">
	...
	<script>
        ...
        var categorySlug = "${category.categorySlug}";
        var pageIndex = 0;
        getCategoryStories();

        function getCategoryStories(){
	        $.ajax({
	        	url: "/rest/category/" + categorySlug + "/" + pageIndex, 
	        	success: function(data){
	            	$(data).each(function(i, item){
	            		var html = prepareStoryTile(item);
	            		$('#category_stories').append(html);
	            	});
	            	if(data.length > 0){
	        			pageIndex+=1;
	        		}
